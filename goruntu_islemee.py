...
konum = 0
otonom = False
cap = cv2.VideoCapture(r"C:\Users\Administrator\Desktop\red.MOV")
#cap = cv2.imread(r"C:\Users\Administrator\Desktop\redtest.png")
...
cv2.setTrackbarPos('low_g','image',0)
cv2.setTrackbarPos('low_r','image',0)
cv2.setTrackbarPos('high_b','image',28)
cv2.setTrackbarPos('high_g','image',255)
cv2.setTrackbarPos('high_r','image',255)
cv2.setTrackbarPos('erosion','image',0)
cv2.setTrackbarPos('ana_motor_hiz','image',0)
...
#while(0):
    ...
    #frame = cv2.imread(r"C:\Users\Administrator\Desktop\redtest.png")
    frameForHC = frame
    frameForUser = frame
